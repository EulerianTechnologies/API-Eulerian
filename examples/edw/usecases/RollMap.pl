...
###############################################################################
#
# @brief Tests script of API::Eulerian::EDW::UseCases::RollMap::Sql().
#
# @file RollMap.pl
#
# @date 04-02-2026
...
# Import RollMap Sql
#
use API::Eulerian::EDW::UseCases::RollMap::Sql;
#
...
sub main
{
  ...
  for my $setup ( @setups ) {
    ...
    my $cmd = API::Eulerian::EDW::UseCases::RollMap::Sql( $setup );
    print( "$cmd\n" );
  }
